...
class PanierItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.admin.panier_items.index', compact('panier'));
    }
    ...
    public function show(PanierItem $panierItem)
    {
        ...
        return view('back.admin.panier_items.show', compact('panierItem'));
    }
    ...
    {
        $this->authorizeAccess($panierItem);
        return view('back.admin.panier_items.edit', compact('panierItem'));
    }
