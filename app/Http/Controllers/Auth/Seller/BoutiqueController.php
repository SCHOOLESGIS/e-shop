...
class BoutiqueController extends Controller
{
    public function index()
    {
        ...
        return view('back.seller.boutique.index', compact('boutiques'));
    }

    public function create()
    {
        return view('back.seller.boutique.create');
    }
    ...
    public function store(StoreBoutiqueRequest $request)
    {
        ...
        return redirect()
                ->route('back.seller.boutique.index')
                ->with('success', 'Boutique créée avec succès.');
    }

    public function show(Boutique $boutique)
    {
        return view('back.seller.boutique.show', compact('boutique'));
    }

    public function edit(Boutique $boutique)
    {
        return view('back.seller.boutique.edit', compact('boutique'));
    }
    ...
    public function update(UpdateBoutiqueRequest $request, Boutique $boutique)
    {
        ...
        return redirect()->route('back.seller.boutique.index')->with('success', 'Boutique mise à jour.');
    }
