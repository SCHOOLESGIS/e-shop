        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>Contact</h1>
                    <p class="mb-4">Nous sommes là pour vous aider ! Si vous avez des questions ou des demandes, n’hésitez pas à nous contacter. Notre équipe est disponible pour vous offrir un service rapide et personnalisé.</p>
                    <p>
                        <p>
                            <a href="#" class="btn btn-secondary me-2">Nous contactez</a>
                            @auth
...
<!-- Start Contact Form -->
<div class="untree_co-section" style="background: url('/images/tic-tac-toe.svg')">
<div class="container">
