...
@section('content')
    <div class="w-full">
        <div class="flex justify-between">
            <a href="{{ route('seller.boutique.index') }}" class="w-[100px] p-2 rounded text-green shadow-md flex gap-2 mb-2 border-2 border-emerald-700 text-emerald-700">
                ...
                <div class="min-h-[400px] w-[300px] border rounded shadow-md relative" style="flex-grow: 1">
                    ...
                    <div class="product-description p-2">
                        <div class="flex justify-between mb-1">
                            <a href="{{ route('seller.produit.show', ['produit' => $item->id]) }}" class="hover:text-amber-500 hover:text-underlined text-lg">{{ $item->name }}</a>
