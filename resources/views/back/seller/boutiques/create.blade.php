...
@section('content')
    <div class="mb-4 flex justify-between">
        ...
        <small class="text-2xl text-slate-400">Créer une boutique</small>
    </div>
    <div class="w-full h-full flex items-center justify-center">
        <form method="POST" action="{{ route('seller.boutique.store') }}" class="w-[400px] min-h-[300px]">
            @csrf
            @method('POST')
            <!-- Email Address -->
            <div>
            ...
            <div class="mt-4">
                ...
                <input type="file" name="logo" id="logo" class="block mt-1 w-full border border-slate-300 shadow-md rounded">
