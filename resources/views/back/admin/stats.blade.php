...
@section('content')
    ...
    <div class="flex gap-3">
        <div class="w-[calc(100%-250px)] border rounded shadow px-2 py-2 flex gap-2 flex-wrap">
            <div class="flex flew-wrap w-full gap-2">
                <div class="border w-[100px] h-[200px] rounded flex items-center justify-center text-xl text-slate-600 bg-blue-500/10 relative overflow-hidden grow">
                ...
                <div id="chart1" class="border w-[300px] h-[200px] rounded flex items-center justify-center text-xl text-slate-600 relative overflow-hidden grow">
                    <div class="absolute top-0 left-1 flex gap-3"><span><i class="fi fi-rr-chart-mixed-up-circle-dollar"></i></span> Chiffre d'affaire total</div>
                    {{-- <img src="{{ asset('/images/dash-bubble.svg') }}" alt="" class="absolute bottom-[-35px] right-[-25px]"> --}}
                </div>
            </div>
